...
# RadExShots
pyinstaller --onefile --noconsole --name RadExShots --icon=assets/radexshots.ico --hidden-import=win32gui --hidden-import=win32con --hidden-import=win32api --hidden-import=pyautogui dev/radexshots.py