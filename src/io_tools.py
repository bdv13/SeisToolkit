...
from config import hdrlen, bin_dict, fmt_dict, tr_dict
from data_types import Dataset, Trace
...
def sgy_input(file_path: Path) -> Dataset:
    ...
    return Dataset(name, text_hdr, byte_order, fmt_code, dt, numsmp, traces)
