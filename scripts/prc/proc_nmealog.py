...
from seistoolkit.tools.geodesy import (
    NMEALogStats,
    get_utm_zone,
    nmea_to_decimal,
    wgs84_to_utm,
...
def batch_nmea_parser() -> None:
    ...
    logs_folder = select_folder('Please select folder with NMEA logs (.nmea)')
    log_paths = get_files(logs_folder, (".nmea",), 'paths')
    output_folder = create_folder(logs_folder, "parsed_logs")
    ...
    jd_logs = create_folder("gps_logs", output_folder)
