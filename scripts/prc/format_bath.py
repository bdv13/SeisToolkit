...
from seistoolkit.tools.geodesy import deg_to_dms, utm_to_wgs84
from seistoolkit.utils import create_folder, get_files, select_folder
...
def main() -> None:
    ...
    folder_path = select_folder('Please, select folder with files:')
    file_paths = get_files(folder_path, (".txt",))
    output_folder = create_folder("bath", folder_path)
